...
fun Path.writeBuildBootstrapXml(context: ProjectGenerationContext) {
    ...
    this.toFile().writeText("""
        <project name="${context.metadata.artifactId.content}_Bootstrap" default="build">
          <!-- Generated by MPS -->
          <property name="build.dir" location="build" />
          <property name="build.tmp" location="${'$'}{build.dir}/tmp/${context.metadata.artifactId.content}_Bootstrap" />
          <property name="build.layout" location="${'$'}{build.dir}/artifacts/${context.metadata.artifactId.content}_Bootstrap" />
