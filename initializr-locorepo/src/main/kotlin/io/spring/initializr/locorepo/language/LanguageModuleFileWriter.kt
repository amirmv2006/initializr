...
fun Path.writeLanguageModule(context: LanguageGenerationContext) {
    //language=XML
    this.toFile().writeText("""
        <?xml version="1.0" encoding="UTF-8"?>
        <language namespace="${context.language.name}" uuid="${context.language.id}" languageVersion="0" moduleVersion="${context.language.moduleVersion}">
          <models>
          ...
          <accessoryModels />
          <generators>
            <generator alias="main" namespace="${context.language.generator.name}" uuid="${context.language.generator.id}">
              <models>
              ...
              <dependencyVersions>
                ...
                <module reference="${context.language.moduleReference()}" version="0" />
                <module reference="${context.language.generator.moduleReference()}" version="0" />
