        ...
        <model ref="r:${context.buildModule.models[0].modelReference()}">
          ...
          <node concept="1l3spW" id="SSBTh98un7">
            ...
            <node concept="2sgV4H" id="6vUa8TkPb6v" role="1l3spa">
                <ref role="1l3spb" node="1LFOa1yjA${'$'}U" resolve="${context.projectDescription.artifactId}_Plugin" />
            </node>
            ...
            <node concept="1l3spV" id="SSBTh98uoh" role="1l3spN">
                ...
                <node concept="398223" id="SSBTh98uoL" role="39821P">
                    ...
                    <node concept="3_I8Xc" id="6vUa8TkPb7i" role="39821P">
                        <ref role="3_I8Xa" node="3PswS${'$'}xWsqQ" resolve="${context.projectDescription.artifactId}" />
                    </node>
