...
public class LoCoRepoProjectController {
	...
	protected TarArchiveOutputStream createTarArchiveOutputStream(OutputStream output) {
		try {
	...
	protected <T extends ArchiveEntry> Path createArchive(ProjectGenerationResult result, String fileExtension,
	...
	protected ResponseEntity<byte[]> upload(Path archive, Path dir, String fileName, String contentType)
			throws IOException {
